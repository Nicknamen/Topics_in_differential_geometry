...
typedef (overloaded) ('a::topological_space, 'e::topological_space) chart =
  "{(d::'a set, d'::'e set, f, f').
...
lift_definition apply_chart::"('a::topological_space, 'e::topological_space) chart \<Rightarrow> 'a \<Rightarrow> 'e"
  is "\<lambda>(d, d', f, f'). f" .

declare [[coercion apply_chart]]

lift_definition inv_chart::"('a::topological_space, 'e::topological_space) chart \<Rightarrow> 'e \<Rightarrow> 'a"
  is "\<lambda>(d, d', f, f'). f'" .

lift_definition domain::"('a::topological_space, 'e::topological_space) chart \<Rightarrow> 'a set"
  is "\<lambda>(d, d', f, f'). d" .

lift_definition codomain::"('a::topological_space, 'e::topological_space) chart \<Rightarrow> 'e set"
  is "\<lambda>(d, d', f, f'). d'" .
...
lift_definition restrict_chart::"'a set \<Rightarrow> ('a::t2_space, 'e::topological_space) chart \<Rightarrow> ('a, 'e) chart"
...
lift_definition compose_chart::"('e\<Rightarrow>'e) \<Rightarrow> ('e\<Rightarrow>'e) \<Rightarrow>
  ('a::topological_space, 'e::topological_space) chart \<Rightarrow> ('a, 'e) chart"
